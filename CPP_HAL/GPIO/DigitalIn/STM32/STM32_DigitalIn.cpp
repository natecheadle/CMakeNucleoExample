...
namespace CPP_HAL{
    ...
    constexpr std::function<void()>& GetFunctor(uint16_t pin) noexcept
    {
        switch(pin)
        {
            case GPIO_PIN_0: return s_InterruptFunctors.at(0);
            case GPIO_PIN_1: return s_InterruptFunctors.at(1);
            case GPIO_PIN_2: return s_InterruptFunctors.at(2);
            case GPIO_PIN_3: return s_InterruptFunctors.at(3);
            case GPIO_PIN_4: return s_InterruptFunctors.at(4);
            case GPIO_PIN_5: return s_InterruptFunctors.at(5);
            case GPIO_PIN_6: return s_InterruptFunctors.at(6);
            case GPIO_PIN_7: return s_InterruptFunctors.at(7);
            case GPIO_PIN_8: return s_InterruptFunctors.at(8);
            case GPIO_PIN_9: return s_InterruptFunctors.at(9);
            case GPIO_PIN_10: return s_InterruptFunctors.at(10);
            case GPIO_PIN_11: return s_InterruptFunctors.at(11);
            case GPIO_PIN_12: return s_InterruptFunctors.at(12);
            case GPIO_PIN_13: return s_InterruptFunctors.at(13);
